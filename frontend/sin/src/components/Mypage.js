...
const Userinfolink = styled(
    Link)`width: 130px; background: #fff; padding: 30px 0 30px 30px; margin-left: 5px;`
...
const Mainleftlink = styled(
    Link)`font-size: 12px; font-weight: bold; color: #777;`
            ...
            <Row>
              <Userinfo>
                <Userinfototal>
                  ...
                  <div>
                    <Link to=''><Userinfototallink>전체등급
                      보기</Userinfototallink></Link>
                    <Link to=''><Userinfototallink>다음 달 예상등급
                      보기</Userinfototallink></Link>
                  </div>
                </Userinfototal>
                <Userinfolinkwrap>
            ...
            <Row>
              <Main>
                <Mainleft>
                  <h2>마이컬리</h2>
                  <Mainleftul>
                    <Mainleftli><Mainleftlink
                        to='/shop/mypage/mypage_orderlist'>주문 내역</Mainleftlink></Mainleftli>
                    <Mainleftli><Mainleftlink
                        to='/shop/mypage/destination/list'>배송지 관리</Mainleftlink></Mainleftli>
                    <Mainleftli><Mainleftlink to='/shop/mypage/mypage_review'>상품
                      후기</Mainleftlink></Mainleftli>
                    <Mainleftli><Mainleftlink to='/shop/mypage/product_inquiry'>상품
                      문의</Mainleftlink></Mainleftli>
                    <Mainleftli><Mainleftlink
                        to='/shop/mypage/mypage_emoney'>적립금</Mainleftlink></Mainleftli>
                    <Mainleftli><Mainleftlink
                        to='/shop/mypage/mypage_coupon'>쿠폰</Mainleftlink></Mainleftli>
                    <Mainleftli><Mainleftlink to=''>개인 정보
                      수정</Mainleftlink></Mainleftli>
                  </Mainleftul>
                </Mainleft>
                <Mainright>
                  <Route path='/shop/mypage/mypage_orderlist' exact
                         component={Mypage_orderlist}/>
                  <Route path='/shop/mypage/destination/list' exact
                         component={Destination}/>
                  <Route path='/shop/mypage/mypage_review' exact
                         component={Mypage_review}/>
                  <Route path='/shop/mypage/product_inquiry' exact
                         component={Product_inquiry}/>
                  <Route path='/shop/mypage/mypage_emoney' exact
                         component={Mypage_emoney}/>
                  <Route path='/shop/mypage/mypage_coupon' exact
                         component={Mypage_coupon}/>
                </Mainright>
              </Main>
            </Row>
          </Container>
