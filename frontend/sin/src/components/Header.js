          ...
          <Row>
            ...
            <Headernav>
                  ...
                  <ul>
                    <Tcnli onMouseOver={() => subnav('subnav1')}
                           onClick={() => history.push(
                               '/shop/goods/goods_list?category=907')}>채소</Tcnli>
                    <Tcnli onMouseOver={() => subnav('subnav2')}
                           onClick={() => history.push(
                               '/shop/goods/goods_list?category=908')}>과일·견과·쌀</Tcnli>
                    <Tcnli onMouseOver={() => subnav('subnav3')}
                           onClick={() => history.push(
                               '/shop/goods/goods_list?category=909')}>수산·해산·건어물</Tcnli>
                    <Tcnli onMouseOver={() => subnav('subnav4')}
                           onClick={() => history.push(
                               '/shop/goods/goods_list?category=910')}>정육·계란</Tcnli>
                    <Tcnli onMouseOver={() => subnav('subnav5')}
                           onClick={() => history.push(
                               '/shop/goods/goods_list?category=911')}>국·반찬·메인요리</Tcnli>
                  </ul>
                  <Totalcategorysubnav>
                    <Subnav1 id='subnav1'>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=907008')}>친환경</Tcsnli>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=907001')}>고구마·감자·당근</Tcsnli>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=907002')}>시금치·쌈채소·나물</Tcsnli>
                    </Subnav1>
                    {/* 채소 */}
                    <Subnav2 id='subnav2'>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=908008')}>친환경</Tcsnli>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=908001')}>제철과일</Tcsnli>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=908002')}>국산과일</Tcsnli>
                    </Subnav2>
                    {/* 과일 */}
                    <Subnav3 id='subnav3'>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=909008')}>제철수산</Tcsnli>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=909001')}>생선류</Tcsnli>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=909002')}>굴비·반건류</Tcsnli>
                    </Subnav3>
                    {/* 수산 */}
                    <Subnav4 id='subnav4'>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=910008')}>국내산
                        소고기</Tcsnli>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=910001')}>수입산
                        소고기</Tcsnli>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=910002')}>돼지고기</Tcsnli>
                    </Subnav4>
                    {/* 정육 */}
                    <Subnav5 id='subnav5'>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=911008')}>국·탕·찌개</Tcsnli>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=911001')}>밀키트·메인요리</Tcsnli>
                      <Tcsnli onClick={() => history.push(
                          '/shop/goods/goods_list?category=911002')}>밑반찬</Tcsnli>
                    </Subnav5>
                    {/* 국 */}
                  </Totalcategorysubnav>
                </Totalcategorynav>
              ...
              <Category className='clearfix'>
                <Categoryitem><Link
                    to='/shop/goods/goods_list?category=038'>신상품</Link></Categoryitem>
                <Categoryitem><Link
                    to='/shop/goods/goods_list?category=029'>베스트</Link></Categoryitem>
                <Categoryitem><Link
                    to='/shop/goods/goods_list?list=sale'>알뜰쇼핑</Link></Categoryitem>
                <Categoryitem><Link
                    to='/shop/goods/event'>특가/혜택</Link></Categoryitem>
              </Category>
