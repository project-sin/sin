          ...
          <Container>
            <Row>
              <Sectionone>
                ...
                <Sectiononedesc>컬리의 새로운 소식들과 유용한 정보들을 한곳에서
                  확인하세요.</Sectiononedesc>
              </Sectionone>
              <Sectiontwo>
                <Sectiontwotable>
                  <Sectiontwotabletr>
              ...
              <Divbtn>
                <Listbtn onClick={() => props.history.push(
                    `/shop/board/list?id=notice`)}>목록</Listbtn>
              </Divbtn>
              <Prevnextul>
                {prevOther.id ? <Prevli onClick={() => props.history.push(
                        `/shop/board/view?id=notice&no=${prevOther.id}`)}><Prevnextlipone>이전글</Prevnextlipone><Prevnextliptwo>{prevOther.title}</Prevnextliptwo></Prevli>
                    : null}
                {nextOther.id ? <Nextli onClick={() => props.history.push(
                        `/shop/board/view?id=notice&no=${nextOther.id}`)}><Prevnextlipone>다음글</Prevnextlipone><Prevnextliptwo>{nextOther.title}</Prevnextliptwo></Nextli>
                    : null}
              </Prevnextul>
            </Row>
          </Container>
