  ...
  const selectorderby = e => {
    ...
    if (e.target.id != selectedli) {
      ...
      if (e.target.id === 'lithr') {
        props.setPageinfo('인기상품순')
      }
      if (e.target.id === 'lifou') {
        props.setPageinfo('혜택순')
      }
      if (e.target.id === 'lifiv') {
        props.setPageinfo('낮은 가격순')
      }
      if (e.target.id === 'lisix') {
        props.setPageinfo('높은 가격순')
      }
      ...
      <Listwrap>
        <Container>
          <Row>
            ...
            <Nav>
              <Navtype>총 {props.products ? Object.keys(props.products).length
                  : ""}건</Navtype>
              <Orderby onClick={togglenav}>{props.pageinfo}</Orderby>
              <Orderbylistul id='nav'>
                <Orderbylistli id='lione'
                               onClick={selectorderby}>추천순</Orderbylistli>
                <Orderbylistli id='litwo'
                               onClick={selectorderby}>신상품순</Orderbylistli>
                <Orderbylistli id='lithr'
                               onClick={selectorderby}>인기상품순</Orderbylistli>
                <Orderbylistli id='lifou'
                               onClick={selectorderby}>혜택순</Orderbylistli>
                <Orderbylistli id='lifiv' onClick={selectorderby}>낮은
                  가격순</Orderbylistli>
                <Orderbylistli id='lisix' onClick={selectorderby}>높은
                  가격순</Orderbylistli>
              </Orderbylistul>
            </Nav>
          </Row>
